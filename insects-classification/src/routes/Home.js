  ...
  return (
   <div className='home'>
     ...
     <div className='home-paragraph'>
        <Text h2 size={28}>
          En esta aplicación podrás clasificar a los insectos de México. Ayuda a proteger las especies endemicas.
        </Text>
      </div>  
      
      <Button className='home-info-button' size="lg" color="gradient" href='/listings'>Más Info.</Button>
